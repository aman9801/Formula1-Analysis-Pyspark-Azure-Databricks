...
.option("header", True) \
.schema(races_schema) \
.csv("/mnt/formula1dl9801/raw/races.csv")
...
races_selected_df.write.mode('overwrite').partitionBy('race_year').parquet('/mnt/formula1dl9801/processed/races')

# COMMAND ----------

display(spark.read.parquet('/mnt/formula1dl9801/processed/races'))